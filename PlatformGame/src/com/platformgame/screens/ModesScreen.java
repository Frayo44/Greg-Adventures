...
public class ModesScreen extends AbstractScreen {
	...
	public static ModeState currentModeState;// = ModeState.EASY;
	
	public ModesScreen(PlatformGame game) {
		super(game);
		this.game = game;
	...
	public void show() {
		super.show();
		 ...
		 tex = new Texture(Gdx.files.internal("images/background.png"));
		...
		stage.addActor(gameOverImage);
		 ...
		 ta = new TextureAtlas(Gdx.files.internal("ui/hardbutton.pack"));
		...
		buttonNextLevel.addListener(new InputListener() {
			...
			public void touchUp(InputEvent event, float x, float y,
					int pointer, int button) {
				currentModeState = ModeState.EASY;
...
//				else game.actionResolver2.loginGPGS2();
				currentModeState = ModeState.HARD;
				game.setScreen(game.getLevelWorldLevelScreen());	
			}
		});
