...
public class LoadingTownScreen extends AbstractScreen {
	...
	public LoadingTownScreen(PlatformGame game) {
		super(game);
	}
	...
	public void show() {
		...
		if (TownLevelsScreen.curlevel == 1) {
		...
		if (TownLevelsScreen.curlevel == 2) {
			game.manager.setLoader(TiledMap.class, new TmxMapLoader(
					new InternalFileHandleResolver()));
		...
		if (TownLevelsScreen.curlevel == 3) {
			game.manager.setLoader(TiledMap.class, new TmxMapLoader(
					new InternalFileHandleResolver()));
		...
		if (TownLevelsScreen.curlevel == 4) {
			game.manager.setLoader(TiledMap.class, new TmxMapLoader(
					new InternalFileHandleResolver()));
		...
		if (TownLevelsScreen.curlevel == 5) {
			game.manager.setLoader(TiledMap.class, new TmxMapLoader(
					new InternalFileHandleResolver()));
		...
		if (TownLevelsScreen.curlevel == 6) {
			game.manager.setLoader(TiledMap.class, new TmxMapLoader(
					new InternalFileHandleResolver()));
		...
		if (TownLevelsScreen.curlevel == 7) {
			game.manager.setLoader(TiledMap.class, new TmxMapLoader(
					new InternalFileHandleResolver()));
		...
		if (TownLevelsScreen.curlevel == 8) {
			game.manager.setLoader(TiledMap.class, new TmxMapLoader(
					new InternalFileHandleResolver()));
		...
		if (TownLevelsScreen.curlevel == 9) {
			game.manager.setLoader(TiledMap.class, new TmxMapLoader(
					new InternalFileHandleResolver()));
		...
		if (TownLevelsScreen.curlevel == 10) {
			game.manager.setLoader(TiledMap.class, new TmxMapLoader(
					new InternalFileHandleResolver()));
		...
		if (TownLevelsScreen.curlevel == 11) {
			game.manager.setLoader(TiledMap.class, new TmxMapLoader(
					new InternalFileHandleResolver()));
		...
		if (TownLevelsScreen.curlevel == 12) {
			game.manager.setLoader(TiledMap.class, new TmxMapLoader(
					new InternalFileHandleResolver()));
	...
	public void render(float delta) {
		...
		System.out.println("dsg" + TownLevelsScreen.curlevel);
		if (game.manager.update()) { // Load some, will return true if done
			loadingBarHidden.addAction(sequence(fadeOut(0.6f),
					run(new Runnable() {
						public void run() {
							switch (TownLevelsScreen.curlevel) {
							case 1:
								if (count == 0) {
									game.setScreen(game.getLevelTown1Screen());
									count = 1;
								}
								break;
							case 2:
								if (count == 0) {
									game.setScreen(game.getLevelTown2Screen());
									count = 1;
								}
								break;
							case 3:
