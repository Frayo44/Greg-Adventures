...
public class Background {
	...
	public Background(TextureRegion image, OrthographicCamera gameCam, float scale) {
		...
		this.scale = scale;
		numDrawX = PlatformGame.V_WIDTH / image.getRegionWidth() + 2;
		numDrawY = 1;// PlatformGame.V_HEIGHT / image.getRegionHeight() + 2;
	}
	...
	public void render(SpriteBatch sb) {
		...
		float y = ((this.y + gameCam.viewportHeight / 2 - gameCam.position.y) * 0) % image.getRegionHeight();
